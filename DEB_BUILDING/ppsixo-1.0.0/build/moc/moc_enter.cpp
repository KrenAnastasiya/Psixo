...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_enter_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 29, 23)
    ...
    "enter\0on_pushButton_clicked\0\0"
...
const QMetaObject enter::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_enter.data,
      qt_meta_data_enter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_enter.stringdata))
